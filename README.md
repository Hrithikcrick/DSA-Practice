...
![GFG](https://img.shields.io/badge/GeeksforGeeks-Practice-darkgreen?style=for-the-badge)
![DSA](https://img.shields.io/badge/DSA-Problem%20Solving-purple?style=for-the-badge)
...
| File | Purpose |
|------|---------|
| problem_name.py | Solution code |
| problem_name.md | Explanation, intuition, dry run, complexity |

Example:

| File | Link |
|------|------|
| Jump Game Code | [jump_game.py](topics/Greedy/jump_game.py) |
| Jump Game Notes | [jump_game.md](topics/Greedy/jump_game.md) |
...
| Platform | Purpose |
|---------|---------|
| LeetCode | Interview-level DSA |
| GeeksforGeeks | Topic-wise DSA |
| CodeChef | Contest practice |
| Codeforces | Future contest practice |
